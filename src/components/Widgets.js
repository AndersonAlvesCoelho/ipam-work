...
import bgOffice from "../assets/img/office/bg-office.jpg";

import teamMembers from "../data/teamMembers";

//CARDS DOS ESCRITÓRIOS DO IPAM
export const CardOfficeIPAM = (props) => {
  const { name, uf, municipio, endereco, codLink } = props;
      ...
      <Card.Body>
        <Row >
          ...
          <Col xl={6} className="text-end">
            <Card.Link href={`/#/dashboard/desktop/${codLink}`} className="text-primary fw-bold">
        ...
        <div className="d-xl-flex align-items-center">
          <div className="d-flex justify-content-xl-center ms-xl-3">
            <div className="d-md-block text-start">
              <div className="fw-normal text-dark mb-1">{uf} - {municipio}</div>
              <div className="text-gray small">{endereco}</div>
            </div>
          </div>
        </div>
      </Card.Body>
...
//FAKE LOADING - CARDS DOS ESCRITÓRIOS DO IPAM
export const LoadingCardOffice = () => {
